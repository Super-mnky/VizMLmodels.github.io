...
function updateBars(house) {
    ...
    if (house != "top")
        specifiedCharList = characters.filter(function(value) {
    ...
    if (house == "top")
        specifiedCharList = characters.filter(function(value) {
            if (value["power_ranking"] > 0) {
                return value
                }    
        })
    
    specifiedCharList.sort(function(a,b) {
        if (a.probability_of_survival > b.probability_of_survival) {
        return -1;
        }
        if (a.probability_of_survival < b.probability_of_survival) {
        return 1;
